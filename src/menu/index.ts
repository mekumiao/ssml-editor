...
import ContinuousMenu from './continuous-menu/continuous-menu'
import ReadMenu from './read-menu'
import DigitalMenu from './digital-menu/digital-menu'
import AliasMenu from './alias-menu/alias-menu'
import EnglishMenu from './english-menu/english-menu'
